...
namespace SEASON3B
{
	enum INTERFACE_LIST
	{
		...
		INTERFACE_MACRO_MAIN,
		INTERFACE_MACRO_SUB_MAIN,
		INTERFACE_MACRO_GAUGERBAR,
...
enum
{
	...
	MAX_MODELS = (MODEL_MASK_HELM + MAX_ITEM_INDEX + 10000),
};
//object end
...
enum
{
	...
	PLAYER_STOP_RIDE_HORSE,   //  Dark Lord attack ( sting ).        (¡Ü) 
	PLAYER_RUN_RIDE_HORSE,   //  Dark Lord Party Summon.             (¡Ü) 
	PLAYER_ATTACK_STRIKE,   //  Stop riding the Dark Horse.          (¡Ü)
