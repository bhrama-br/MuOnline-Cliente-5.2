	...
	case 506:
		{
			...
			strcpy(pCharacter->ID, "\xB7\xB9\xC0\xCC\xB8\xF3\xB5\xE5");
	...
	case 507:
		{
			...
			strcpy(pCharacter->ID, "\xBF\xA1\xB8\xA3\xC4\xAD\xB4\xC0");
	...
	case 508:
		{
			...
			strcpy(pCharacter->ID, "\xB5\xA5\xBD\xBD\xB7\xAF");
	...
	case 511:
		{
			...
			strcpy(pCharacter->ID, "\xB0\xA5\xB8\xAE\xBE\xC6");
	...
	case 512:
		{
			...
			strcpy(pCharacter->ID, "\xBA\xB4\xC2\xFC\xC0\xE5\xB1\xB3");
	...
	case 513:
		{
			...
			strcpy(pCharacter->ID, "\xC0\xFC\xC5\xF5\xB1\xB3\xB0\xFC");
			pCharacter->Object.Scale = 1.25f;
		}
		break;
	case 518:
		{
			...
			strcpy(pCharacter->ID, "\xBC\xF6\xC8\xA3\xB1\xBA\xB9\xE6\xC6\xD0\xBA\xB4");
	...
	case 519:
		{
			...
			strcpy(pCharacter->ID, "\xBC\xF6\xC8\xA3\xB1\xBA\xC4\xA1\xC0\xAF\xBA\xB4");	
	...
	case 520:
		{
			...
			strcpy(pCharacter->ID, "\xB1\xE2\xBB\xE7\xB4\xDC");
	...
	case 521:
		{
			...
			strcpy(pCharacter->ID, "\xC8\xA3\xC0\xA7\xBA\xB4");
			pCharacter->Object.Scale = 1.1f;
		}
		break;
	case 524:
		{
			...
			strcpy(pCharacter->ID, "\xC3\xA2\xBB\xEC\xC7\xFC \xBC\xBA\xB9\xAE");
	...
	case 525:
		{
			...
			strcpy(pCharacter->ID, "\xBB\xE7\xC0\xDA\xB8\xD3\xB8\xAE \xBC\xBA\xB9\xAE");
			pCharacter->Object.m_bRenderShadow = false;
	...
	case 526:
		{
			...
			strcpy(pCharacter->ID, "\xBC\xAE\xBB\xF3");
			pCharacter->Object.m_bRenderShadow = false;
...
void GMEmpireGuardian1::RenderFrontSideVisual()
{
	...
	case WEATHER_FOG:
		{
			EnableAlphaBlend();
			SetLegacyColor3f(0.6f,0.6f,0.9f);
	...
	case WEATHER_STORM:
        ...
        if (rand_fps_check(20))
			{
				EnableAlphaBlend();
				SetLegacyColor3f(0.7f,0.7f,0.9f);
