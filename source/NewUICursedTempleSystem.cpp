...
{
	EnableAlphaTest();
	SetLegacyColor4f( 1.f, 1.f, 1.f, m_Alph );
	...
	SetLegacyColor4f( 0.9f, 0.4f, 0.1f, m_Alph);
...
void SEASON3B::CNewUICursedTempleSystem::RenderGameTime()
{
	...
	SetLegacyColor4f( 1.f, 0.6f, 0.3f, m_Alph );
	...
	SetLegacyColor4f( 0.f, 0.f, 0.f, m_Alph );
...
void SEASON3B::CNewUICursedTempleSystem::RenderScore()
{
	...
	::EnableAlphaTest();
	::SetLegacyColor4f(1.0f, 1.0f, 1.0f, m_ScoreEffectAlph);
