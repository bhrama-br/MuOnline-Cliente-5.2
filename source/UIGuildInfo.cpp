...
void CUIGuildInfo::Render()
{
	...
	SetLegacyColor4ub( 146, 144, 141, 255 );
	...
	if( m_nCurrentTab == 0 ) SetLegacyColor4f( 1.f, 1.f, 1.f, 1.f );
	else SetLegacyColor4f( 0.6f, 0.6f, 0.6f, 1.f );
	...
	ptOrigin.x += 54;
	if( m_nCurrentTab == 1 ) SetLegacyColor4f( 1.f, 1.f, 1.f, 1.f );
	else SetLegacyColor4f( 0.6f, 0.6f, 0.6f, 1.f );
	...
	ptOrigin.x += 54;
	if( m_nCurrentTab == 2 ) SetLegacyColor4f( 1.f, 1.f, 1.f, 1.f );
	else SetLegacyColor4f( 0.6f, 0.6f, 0.6f, 1.f );
