...
// Declaracoes icadas para escopo de ARQUIVO. Estavam dentro de metodos de
// SEASON4A, e ali `extern X` nomeia SEASON4A::X, nao o global ::X.
...
CHARACTER* CGM_Raklion::CreateMonster(int iType, int PosX, int PosY, int Key)
{
	...
	case 454:
		...
		strcpy(pCharacter->ID, "\xBE\xC6\xC0\xCC\xBD\xBA \xBF\xF6\xC4\xBF");
	...
	case 455:
		...
		strcpy(pCharacter->ID, "\xC0\xDA\xC0\xCC\xBE\xF0\xC6\xAE \xB8\xC5\xB8\xD3\xB5\xE5");
	...
	case 456:
		...
		strcpy(pCharacter->ID, "\xBE\xC6\xC0\xCC\xBD\xBA \xC0\xDA\xC0\xCC\xBE\xF0\xC6\xAE");
		pCharacter->Object.Scale = 1.0f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
	...
	case 457:
		...
		strcpy(pCharacter->ID, "\xC4\xF0\xB7\xAF\xC6\xBE");
		pCharacter->Object.Scale = 1.0f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		break;
	...
	case 458:
		...
		strcpy(pCharacter->ID, "\xBE\xC6\xC0\xCC\xBE\xF0 \xB3\xAA\xC0\xCC\xC6\xAE");
	...
	case 459:
		{
			...
			strcpy(pCharacter->ID, "\xBC\xBC\xB7\xE7\xC6\xC7");
	...
	case 460:
		{
			...
			strcpy(pCharacter->ID, "\xB0\xC5\xB4\xEB \xB0\xC5\xB9\xCC\xBE\xCB");
	...
	case 562:
		{
			...
			strcpy(pCharacter->ID, "\xB4\xC5\xA9 \xC0\xDA\xC0\xCC\xBE\xF0\xC6\xAE \xB8\xC5\xB8\xD3\xB5\xE5");
			//pCharacter->Object.Scale = 1.7f;
	...
	case 563:
		{
			...
			strcpy(pCharacter->ID, "\xB4\xC5\xA9 \xC0\xDA\xC0\xCC\xBE\xF0\xC6\xAE");
			//pCharacter->Object.Scale = 1.0f;
	...
	case 564:
		{
			...
			strcpy(pCharacter->ID, "\xB4\xC5\xA9 \xC4\xF0\xB7\xAF\xC6\xBE");
			//pCharacter->Object.Scale = 1.0f;
	...
	case 565:
		{
			...
			strcpy(pCharacter->ID, "\xB4\xC5\xA9 \xBE\xC6\xC0\xCC\xBE\xF0 \xB3\xAA\xC0\xCC\xC6\xAE");
			//pCharacter->Object.Scale = 1.5f;
...
{
	EnableAlphaBlend();
	SetLegacyColor3f(0.4f,0.4f,0.45f);
