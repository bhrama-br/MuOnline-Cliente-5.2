...
//        case    18 :
    ...
    CHARACTER* CreateBattleCastleMonster ( int Type, int PositionX, int PositionY, int Key )
    {
        ...
        case 217:
		    ...
		    c->Weapon[0].Type = -1;
		    c->Weapon[1].Type = -1;
 			strcpy( c->ID, "\xBF\xD5\xB0\xFC \xB9\xDF\xC6\xC7""2" );
        ...
        case 218:
		    ...
		    c->Weapon[0].Type = -1;
		    c->Weapon[1].Type = -1;
 			strcpy( c->ID, "\xBF\xD5\xB0\xFC \xB9\xDF\xC6\xC7""1" );
            c->Object.Velocity = c->Object.Position[2];
            if ( IsBattleCastleStart()==false )
                c->Object.Position[2] -= 100.f;
            break;
        ...
        case 219:
		    ...
		    c->Weapon[0].Type = -1;
		    c->Weapon[1].Type = -1;
 			strcpy( c->ID, "\xBC\xBA\xB9\xAE \xBD\xBA\xC0\xA7\xC4\xA1" );
            break;
        ...
        case 220:
		    ...
		    c->Weapon[0].Type = -1;
		    c->Weapon[1].Type = -1;
 			strcpy( c->ID, "\xBB\xE7\xB3\xC9\xC5\xCD \xB9\xAE\xC1\xF6\xB1\xE2" );
            break;
        ...
        case 223:
		    ...
		    c->Weapon[0].Type = -1;
		    c->Weapon[1].Type = -1;
 			strcpy( c->ID, "\xBF\xF8\xB7\xCE\xBF\xF8" );
            break;
        ...
        case 224:
		    ...
		    c->Weapon[0].Type = -1;
		    c->Weapon[1].Type = -1;
			strcpy( c->ID, "\xB1\xC0\xA7\xBA\xB4" );
            break;
