    ...
    case BITMAP_JOINT_THUNDER:
        ...
        for (int j = 0; j < o->MaxTails; j++)
        {
            ...
            case 24:
            {
                ...
                {
                    assert(!"\xB5\xF0\xB9\xF6\xB1\xEB");
                }
            }
            break;
            case 25:
                ...
                for (int j = 0; j < 8; ++j)
                {
                    if ((int)o->NumTails < o->MaxTails - 1)
                    {
                        ...
                        if (o->SubType == 0)
                        {
                            ...
                            CreateJointFpsChecked(BITMAP_JOINT_THUNDER, Light, o->Position, o->Angle, 3, NULL, rand() % 10 + 5.f, 5, 10); //  Àü±â
                            CreateJointFpsChecked(BITMAP_JOINT_THUNDER, Light, o->Position, o->Angle, 3, NULL, rand() % 8 + 4.f, 5, 10); //  Àü±â
                        }
                    }
                    if (o->SubType == 0)
                    {
        ...
        if (o->Live && o->NumTails > 0 && o->RenderFace != 0)
        {
            ...
            if (o->Type == MODEL_SPEARSKILL)
            {
                ...
                case 10:
                    ...
                    Platform::GetLegacyRenderAdapter().Color4f(fAlpha * o->Light[0], fAlpha * o->Light[1], fAlpha * o->Light[2], 1.f);
                    break;
                case 3:
                case 5:
                case 6:
                ...
                case 14:
                case 17:
                    Platform::GetLegacyRenderAdapter().Color4f(o->Light[0], o->Light[1], o->Light[2], 1.f);
                    break;
                case 15:
                    Platform::GetLegacyRenderAdapter().Color4f(o->Light[0], o->Light[1], o->Light[2], 1.f);
                    EnableAlphaBlendMinus();
            ...
            for (int j = 0; j < (int)o->NumTails; j++)
            {
                ...
                if (o->Type == BITMAP_JOINT_FORCE && o->SubType == 0)
                {
                    ...
                    Platform::GetLegacyRenderAdapter().Color4f(Luminosity, Luminosity, Luminosity, 1.f);

                    Platform::ILegacyRenderAdapter& renderer = Platform::GetLegacyRenderAdapter();
                    renderer.Begin(Platform::LegacyPrimitiveQuads);
                    renderer.TexCoord2f(Light1, 0.f); renderer.Vertex3fv(currentTail[0]);
                    renderer.TexCoord2f(Light1, 1.f); renderer.Vertex3fv(currentTail[1]);
                    renderer.TexCoord2f(Light2, 1.f); renderer.Vertex3fv(nextTail[1]);
                    renderer.TexCoord2f(Light2, 0.f); renderer.Vertex3fv(nextTail[0]);
                    renderer.End();
                }
                else
                {
                        ...
                        ))
                    {
                        ...
                        if (o->Target != NULL)
                        {
                            ...
                            if (fJointHeight > 0)
                            {
                                ...
                                Platform::GetLegacyRenderAdapter().Color4f(Light[0], Light[1], Light[2], 1.f);
                            }
                            else
                            {
                                VectorCopy(o->Light, Light);
                                Platform::GetLegacyRenderAdapter().Color4f(o->Light[0], o->Light[1], o->Light[2], 1.f);//1.f,1.f,1.f);
                            }
                        }
                        else
                        {
                    ...
                    else if (o->Type == BITMAP_JOINT_THUNDER + 1 && o->SubType == 0)
                    {
                        ...
                        {
                            float l = o->Light[2] - j;
                            Platform::GetLegacyRenderAdapter().Color4f(l, l, l, 1.f);
                        }
                        else if (tail < j)
                        {
                            Platform::GetLegacyRenderAdapter().Color4f(0.f, 0.f, 0.f, 1.f);
                        }
                        else
                        {
                            Platform::GetLegacyRenderAdapter().Color4f(0.7f, 0.7f, 0.7f, 1.f);
                        }
                    }
                        ...
                        )
                    {
                        ...
                        Platform::GetLegacyRenderAdapter().Color4f(o->Light[0] * Luminosity, o->Light[1] * Luminosity, o->Light[2] * Luminosity, 1.f);
                    }
                    ...
                    if (o->Type == BITMAP_FLARE && o->SubType == 22)
                    {
                        ...
                        Platform::ILegacyRenderAdapter& renderer = Platform::GetLegacyRenderAdapter();
                        renderer.Begin(Platform::LegacyPrimitiveQuads);
                        renderer.TexCoord2f(Light1, 1.f); renderer.Vertex3fv(currentTail[2]);
                        renderer.TexCoord2f(Light1, 0.f); renderer.Vertex3fv(currentTail[3]);
                        renderer.TexCoord2f(Light2, 0.f); renderer.Vertex3fv(o->Tails[j + 1][3]);
                        renderer.TexCoord2f(Light2, 1.f); renderer.Vertex3fv(o->Tails[j + 1][2]);
                        renderer.TexCoord2f(Light1, 0.f); renderer.Vertex3fv(currentTail[0]);
                        renderer.TexCoord2f(Light1, 1.f); renderer.Vertex3fv(currentTail[1]);
                        renderer.TexCoord2f(Light2, 1.f); renderer.Vertex3fv(o->Tails[j + 1][1]);
                        renderer.TexCoord2f(Light2, 0.f); renderer.Vertex3fv(o->Tails[j + 1][0]);
                        renderer.End();
                    ...
                    if ((o->RenderFace & RENDER_FACE_ONE) == RENDER_FACE_ONE)
                    {
                        Platform::ILegacyRenderAdapter& renderer = Platform::GetLegacyRenderAdapter();
                        renderer.Begin(Platform::LegacyPrimitiveQuads);
                        renderer.TexCoord2f(L1, V2); renderer.Vertex3fv(currentTail[2]);
                        renderer.TexCoord2f(L1, V1); renderer.Vertex3fv(currentTail[3]);
                        renderer.TexCoord2f(L2, V1); renderer.Vertex3fv(nextTail[3]);
                        renderer.TexCoord2f(L2, V2); renderer.Vertex3fv(nextTail[2]);
                        renderer.End();
                    }
                    ...
                    if ((o->RenderFace & RENDER_FACE_TWO) == RENDER_FACE_TWO)
                    {
                        ...
                        Platform::ILegacyRenderAdapter& renderer = Platform::GetLegacyRenderAdapter();
                        renderer.Begin(Platform::LegacyPrimitiveQuads);
                        renderer.TexCoord2f(L1, V1); renderer.Vertex3fv(currentTail[0]);
                        renderer.TexCoord2f(L1, V2); renderer.Vertex3fv(currentTail[1]);
                        renderer.TexCoord2f(L2, V2); renderer.Vertex3fv(nextTail[1]);
                        renderer.TexCoord2f(L2, V1); renderer.Vertex3fv(nextTail[0]);
                        renderer.End();
                    }
                }
            }
