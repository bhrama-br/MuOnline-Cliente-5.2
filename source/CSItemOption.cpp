...
void CSItemOption::getExplainText(char* text, const BYTE option, const BYTE value, const BYTE SetIndex)
{
	...
	{
	case AT_SET_OPTION_IMPROVE_MAGIC_POWER:                   //  ¸¶·Â Áõ°¡.
		sprintf(text, GlobalText[632], value);
		break;

	case AT_SET_OPTION_IMPROVE_STRENGTH: 				//	Èû Áõ°¡
	case AT_SET_OPTION_IMPROVE_DEXTERITY: 			    //	¹ÎÃ¸¼º Áõ°¡
	case AT_SET_OPTION_IMPROVE_ENERGY: 				    //	¿¡³ÊÁö Áõ°¡	                 
	case AT_SET_OPTION_IMPROVE_VITALITY: 				//	Ã¼·Â Áõ°¡
	case AT_SET_OPTION_IMPROVE_CHARISMA:                //  Åë¼Ö·Â Áõ°¡.
	case AT_SET_OPTION_IMPROVE_ATTACK_MIN:              //  ÃÖ¼Ò °ø°Ý·Â Áõ°¡.
	case AT_SET_OPTION_IMPROVE_ATTACK_MAX:              //  ÃÖ´ë °ø°Ý·Â Áõ°¡.
		sprintf(text, GlobalText[950 + option], value);
		break;

	case AT_SET_OPTION_IMPROVE_DAMAGE: 	                //	µ¥¹ÌÁö Áõ°¡	 
	case AT_SET_OPTION_IMPROVE_ATTACKING_PERCENT: 		//	°ø°Ý ¼º°ø·ü Áõ°¡  
	case AT_SET_OPTION_IMPROVE_DEFENCE: 			    //	¹æ¾î·Â Áõ°¡		 
	case AT_SET_OPTION_IMPROVE_MAX_LIFE: 				//	ÃÖ´ë »ý¸í·Â Áõ°¡
	case AT_SET_OPTION_IMPROVE_MAX_MANA: 				//	ÃÖ´ë ¸¶³ª Áõ°¡
	case AT_SET_OPTION_IMPROVE_MAX_AG: 					//	ÃÖ´ë AG Áõ°¡		             
	case AT_SET_OPTION_IMPROVE_ADD_AG:                  //  AG Áõ°¡¾ç Áõ°¡.
	case AT_SET_OPTION_IMPROVE_CRITICAL_DAMAGE_PERCENT: //  Å©¸®Æ¼ÄÃ µ¥¹ÌÁö È®·ü Áõ°¡.
	case AT_SET_OPTION_IMPROVE_CRITICAL_DAMAGE:         //  Å©¸®Æ¼ÄÃ µ¥¹ÌÁö Áõ°¡.
	case AT_SET_OPTION_IMPROVE_EXCELLENT_DAMAGE_PERCENT://  ¾×¼³·±Æ® µ¥¹ÌÁö È®·ü Áõ°¡.
	case AT_SET_OPTION_IMPROVE_EXCELLENT_DAMAGE:        //  ¾×¼³·±Æ® µ¥¹ÌÁö Áõ°¡.
	case AT_SET_OPTION_IMPROVE_SKILL_ATTACK:            //  ½ºÅ³ °ø°Ý·Â Áõ°¡.
	case AT_SET_OPTION_DOUBLE_DAMAGE:					//	´õºí µ¥¹ÌÁö È®·ü
		sprintf(text, GlobalText[949 + option], value);
		break;

	case AT_SET_OPTION_DISABLE_DEFENCE:
		sprintf(text, GlobalText[970], value);        //  Àû ¹æ¾î·Â ¹«½Ã.
		break;

	case AT_SET_OPTION_TWO_HAND_SWORD_IMPROVE_DAMAGE: 	//	µÎ¼Õ°Ë Àåºñ½Ã µ¥¹ÌÁö 15% Áõ°¡	 
		sprintf(text, GlobalText[983], value);
		break;

	case AT_SET_OPTION_IMPROVE_SHIELD_DEFENCE: 			//	¹æÆÐ Àåºñ½Ã ¹æ¾î·Â 5% Áõ°¡		 
		sprintf(text, GlobalText[984], value);
		break;


	case AT_SET_OPTION_IMPROVE_ATTACK_1: 				//	Æ¯Á¤ Ä³¸¯ÅÍ °ø°Ý·Â Áõ°¡ ¹ÎÃ¸¼º/60
	case AT_SET_OPTION_IMPROVE_ATTACK_2: 				//	Æ¯Á¤ Ä³¸¯ÅÍ °ø°Ý·Â Áõ°¡ Èû/50	 
	case AT_SET_OPTION_IMPROVE_MAGIC: 					//	Æ¯Á¤ Ä³¸¯ÅÍ ¸¶·Â Áõ°¡ ¿¡³ÊÁö/70	 
//	case AT_SET_OPTION_IMPROVE_DEFENCE_1: 				//	Æ¯Á¤ Ä³¸¯ÅÍ ¹æ¾î·Â Áõ°¡ ·¹º§/20	 
//	case AT_SET_OPTION_IMPROVE_DEFENCE_2: 				//	Æ¯Á¤ Ä³¸¯ÅÍ ¹æ¾î·Â Áõ°¡ 3%		 
	case AT_SET_OPTION_IMPROVE_DEFENCE_3: 				//	Æ¯Á¤ Ä³¸¯ÅÍ ¹æ¾î·Â Áõ°¡ ¹ÎÃ¸¼º/50
	case AT_SET_OPTION_IMPROVE_DEFENCE_4: 				//	Æ¯Á¤ Ä³¸¯ÅÍ ¹æ¾î·Â Áõ°¡ Ã¼·Â/40	 
	case AT_SET_OPTION_FIRE_MASTERY: 					//	Æ¯Á¤ Ä³¸¯ÅÍ ºÒ¼Ó¼º Ãß°¡			 
	case AT_SET_OPTION_ICE_MASTERY: 					//	Æ¯Á¤ Ä³¸¯ÅÍ ¾óÀ½¼Ó¼º Ãß°¡		 
	case AT_SET_OPTION_THUNDER_MASTERY: 				//	Æ¯Á¤ Ä³¸¯ÅÍ ¹ø°³¼Ó¼º Ãß°¡		 
	case AT_SET_OPTION_POSION_MASTERY: 					//	Æ¯Á¤ Ä³¸¯ÅÍ µ¶¼Ó¼º Ãß°¡			 
	case AT_SET_OPTION_WATER_MASTERY: 					//	Æ¯Á¤ Ä³¸¯ÅÍ ¹°¼Ó¼º Ãß°¡			 
	case AT_SET_OPTION_WIND_MASTERY: 					//	Æ¯Á¤ Ä³¸¯ÅÍ ¹Ù¶÷¼Ó¼º Ãß°¡		 
	case AT_SET_OPTION_EARTH_MASTERY: 					//	Æ¯Á¤ Ä³¸¯ÅÍ ¶¥¼Ó¼º Ãß°¡			 
...
int CSItemOption::GetDefaultOptionValue(ITEM* ip, DWORD* Value)
{
...
int CSItemOption::RenderDefaultOptionText(const ITEM* ip, int TextNum)
{
	...
	if (GetDefaultOptionText(ip, TextList[TNum]))
	{
		...
		{
			sprintf(TextList[TNum], "%s", GlobalText[1165]);
			TextListColor[TNum] = TEXT_COLOR_BLUE;
			TNum++;
		}
	}
