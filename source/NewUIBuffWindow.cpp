...
{
	// PC used four fixed widths: 640->220, 450->125, 373->86 and 260->30.
	// They all follow (width - 200) / 2. Keep that layout for arbitrary
	// browser canvas widths instead of falling back to the 640-pixel position.
	const int x = max(30, (iScreenWidth - 200) / 2);
	SetPos(x, 15);
}
