	...
	case 351:
		{
			...
			strcpy( pCharacter->ID, "\xBD\xBA\xC7\xC3\xB8\xB0\xC5\xCD \xBF\xEF\xC7\xC1" );
	...
	case 352:
		{
			...
			strcpy( pCharacter->ID, "\xBE\xC6\xC0\xCC\xBE\xF0 \xB6\xF3\xC0\xCC\xB4\xF5" );	
		}
		break;
	case 354:
		{
			...
			strcpy( pCharacter->ID, "\xBA\xED\xB7\xB9\xC0\xCC\xB5\xE5 \xC7\xE5\xC5\xCD" );	
		}
		break;
	case 353:
		{
			...
			pCharacter->Weapon[0].Type = -1;
			pCharacter->Weapon[1].Type = -1;
			strcpy( pCharacter->ID, "\xBB\xE7\xC6\xBC\xB7\xCE\xBD\xBA" );	
		}
		break;
	case 355:
		{
			...
			strcpy( pCharacter->ID, "\xC4\xCB\xC5\xB8\xBF\xEC\xB7\xCE\xBD\xBA" );	
		}
		break;
	case 553:
		{
	...
	case 554:
		{
			...
			BoneManager::RegisterBone(pCharacter, "KENTAUROS_BIP_SPAIN_2",5 );
			BoneManager::RegisterBone(pCharacter, "KENTAUROS_BIP_SPAIN_3", 6);
			strcpy( pCharacter->ID, "\xC4\xCB\xC5\xB8\xBF\xEC\xB7\xCE\xBD\xBA\xBF\xF6\xB8\xAE\xBE\xEE" );	
		}
		break;
	case 555:
		{
