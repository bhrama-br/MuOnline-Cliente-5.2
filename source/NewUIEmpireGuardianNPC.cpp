...
void CNewUIEmpireGuardianNPC::SetPos(int x, int y)
{
	m_Pos.x = x;
	m_Pos.y = y;
	m_btPositive.ChangeButtonInfo(m_Pos.x + (NPC_WINDOW_WIDTH / 2) - 27, m_Pos.y + 190, 53, 23);
	m_btNegative.ChangeButtonInfo(m_Pos.x + (NPC_WINDOW_WIDTH / 2) - 27, m_Pos.y + 380, 53, 23);
}
