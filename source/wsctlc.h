...
// LegacySendWouldBlock, usada no sSend inline abaixo. No Windows este cabecalho e
// vazio e o build do PC continua com o Winsock de verdade.
#include "Platform/WinsockCompat.h"
// RearmLegacySocketWrite, chamada quando o envio entra na fila.
...
#else
				// Inclui ENOTCONN: ver LegacySendWouldBlock em
				// Platform/WinsockCompat.h.
...
#if !defined(_WIN32)
					// Pede um FD_WRITE novo, que e o que esvazia esta fila -- ver
