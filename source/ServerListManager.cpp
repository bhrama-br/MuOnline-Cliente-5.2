...
{
	// LegacyFileOpen, nao ::fopen -- e o unico ponto que normaliza a barra invertida
	// e aciona a busca de asset sob demanda. Com o fopen cru, no Web o arquivo NUNCA
	// abria (o nome inteiro, com barras invertidas, virava um unico componente), a
	// lista de servidores ficava vazia e a tentativa de conexao saia com
	// "ip address = (null)". No Windows a funcao e repasse direto para fopen.
	FILE* fp = Platform::LegacyFileOpen("Data\\Local\\ServerList.bmd", "rb");
