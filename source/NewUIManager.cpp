...
{
	gInterface.interfaceLock = 0;

	gJewelStack.UpdateMouseEvent();

	gInterface.m_Lua.Generic_Call("UpdateMouse", ">");

	if (gInterface.interfaceLock) 
	{
		return 1;
	}
...
bool SEASON3B::CNewUIManager::UpdateKeyEvent()
{
	...
	gInterface.m_Lua.Generic_Call("UpdateKey", ">");
...
{
	gInterface.m_Lua.Generic_Call("UpdateProc", ">");
