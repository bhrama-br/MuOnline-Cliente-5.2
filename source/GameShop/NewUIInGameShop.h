...
namespace SEASON3B
{
	...
	private:
		...
		{
			TEXT_IGS_CHAR_NAME_POS_X = 498,	// Character Á¤º¸
			TEXT_IGS_CHAR_NAME_POS_Y = 23,
			TEXT_IGS_CHAR_NAME_WIDTH = 122,
			TEXT_IGS_CASH_POS_X = 498,		// Cash Á¤º¸
			TEXT_IGS_CASH_POS_Y = 50,
			TEXT_IGS_CASH_WIDTH = 130,
			TEXT_IGS_MILEAGE_POS_Y = 65,		// Point Á¤º¸
			TEXT_IGS_POINT_POS_Y = 80,		// Mileage Á¤º¸
			TEXT_IGS_STORAGE_NAME_POS_X = 492,	// º¸°üÇÔÁ¦¸ñ - ÀÌ¸§
			TEXT_IGS_STORAGE_NAME_POS_Y = 233,
			TEXT_IGS_STORAGE_NAME_WIDTH = 96,
			TEXT_IGS_STORAGE_TIME_POS_X = 592,	// º¸°üÇÔÁ¦¸ñ - ±â°£
			TEXT_IGS_STORAGE_TIME_WIDTH = 34,
			TEXT_IGS_PAGE_POS_X = 251,		// Page Á¤º¸
			TEXT_IGS_PAGE_POS_Y = 404,
			TEXT_IGS_STORAGE_PAGE_INFO_POS_X = 518,	// º¸°üÇÔ Page Á¤º¸
		...
		enum INGAMESHOP_IMAGES_POS
		{
			...
			IMAGE_IGS_ICON_BTN_POS_Y = 94,		// °¢Á¾ ¾ÆÀÌÄÜ(Gift, Cash, Refrash) Button
			IMAGE_IGS_USE_BTN_POS_X = 572,		// »ç¿ëÇÏ±â ¹öÆ°
			IMAGE_IGS_USE_BTN_POS_Y = 396,
			IMAGE_IGS_ITEMBOX_LOGO_POS_X = 128,		// ¾ÆÀÌÅÛ¹Ú½º ·Î°í
		...
		enum INGAMESHOP_IMAGES_SIZE
		{
			...
			IMAGE_IGS_ICON_BTN_WIDTH = 25,		// °¢Á¾ ¾ÆÀÌÄÜ(Gift, Cash, Refrash, Delete) Button
			IMAGE_IGS_ICON_BTN_HEIGHT = 25,
			IMAGE_IGS_ITEMBOX_LOGO_SIZE = 57,		// ¾ÆÀÌÅÛ¹Ú½º ·Î°í
		...
		{
			IGS_WIDTH_POS_X = 129,		// DisplayÇÒ ItemÀÇ ½ÃÀÛÀ§Ä¡
			IGS_HEIGHT_POS_Y = 59,
			IGS_SIZE_WIDTH = 60,		// DisplayÇÒ ItemÀÇ Å©±â
			IGS_SIZE_HEIGHT = 49,
			IGS_NUM_ITEMS_WIDTH = 3,	// DisplayÇÒ ItemÀÇ °¹¼ö
			IGS_NUM_ITEMS_HEIGHT = 3,
			IGS_PACKAGE_NAME_POS_X = 105,	// DisplayÇÒ ItemÀÇ Name ½ÃÀÛÀ§Ä¡
			IGS_PACKAGE_NAME_POS_Y = 40,
			IGS_PACKAGE_NAME_WIDTH = 104,	// DisplayÇÒ ItemÀÇ Name ¹üÀ§
			IGS_PACKAGE_PRICE_POS_Y = 60,	// DisplatÇÒ ItemÀÇ °¡°Ý ½ÃÀÛÀ§Ä¡
			IGS_ITEMRENDER_POS_X_STANDAD = 102,	// ¾ÆÅÛ ·£´õÇÒ ±âÁØ
			IGS_ITEMRENDER_POS_WIDTH = 108,	// ¾ÆÅÛ ±×¸± ¹Ú½º
			IGS_ITEMRENDER_POS_Y_STANDAD = 51,	// ¾ÆÅÛ ·£´õÇÒ ±âÁØ
			IGS_ITEMRENDER_POS_HEIGHT = 58,	// ¾ÆÅÛ ±×¸± ¹Ú½º
			IGS_STORAGE_TOTAL_ITEM_PER_PAGE = 9,	// º¸°üÇÔ ÆäÀÌÁö´ç ¾ÆÀÌÅÛÀÇ °¹¼ö
		};
