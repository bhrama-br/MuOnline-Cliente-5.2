	...
	case 504:
		{
			...
			strcpy(pCharacter->ID, "\xB0\xA1\xC0\xCC\xBF\xC2 \xC4\xAB\xB7\xB9\xC0\xCE");
	...
	case 522:
		{
			...
			strcpy(pCharacter->ID, "\xC1\xA6\xB8\xB0\xC6\xAE");
	...
	case 527:
		{
			...
			strcpy(pCharacter->ID, "\xC1\xD6\xB8\xBB \xC3\xA2\xBB\xEC \xBC\xBA\xB9\xAE");
	...
	case 528:
		{
			...
			strcpy(pCharacter->ID, "\xC1\xD6\xB8\xBB \xBC\xBA\xB9\xAE");
			pCharacter->Object.m_bRenderShadow = false;
