...
CHARACTER* GMSwampOfQuiet::CreateSwampOfQuietMonster(int iType, int PosX, int PosY, int Key)
{
	...
	case 441:
		...
		strcpy(pCharacter->ID,"\xBB\xE7\xC7\xC7-\xBF\xEC\xB4\xA9\xBD\xBA");
...
// 		}
	...
	case 442:
		...
		strcpy(pCharacter->ID,"\xBB\xE7\xC7\xC7-\xB5\xCE\xBF\xC0");
		pCharacter->Object.Scale = 1.0f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
// 		{
...
// 		}
	...
	case 443:
		...
		strcpy(pCharacter->ID,"\xBB\xE7\xC7\xC7-\xC6\xAE\xB7\xB9\xBD\xBA");
		pCharacter->Object.Scale = 1.0f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
// 		{
...
// 		}
	...
	case 444:
		...
		strcpy(pCharacter->ID,"\xBD\xA6\xB5\xB5\xBF\xEC \xC6");
	...
	case 445:
		...
		strcpy(pCharacter->ID,"\xBD\xA6\xB5\xB5\xBF\xEC \xB3\xAA\xC0\xCC\xC6\xAE");
		pCharacter->Object.Scale = 1.1f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		pCharacter->Object.LifeTime = 100;
	...
	case 446:
		...
		strcpy(pCharacter->ID,"\xBD\xA6\xB5\xB5\xBF\xEC \xB7\xE8");
	...
	case 447:
		...
		strcpy(pCharacter->ID,"\xBD\xE3\xB4\xF5 \xB3\xD7\xC0\xCC\xC7\xC9");
	...
	case 448:
		...
		strcpy(pCharacter->ID,"\xB0\xED\xBD\xBA\xC6\xAE \xB3\xD7\xC0\xCC\xC7\xC9");
		pCharacter->Object.Scale = 0.95f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		break;
	case 449:
		...
		strcpy(pCharacter->ID,"\xBA\xED\xB7\xB9\xC0\xCC\xC1\xEE \xB3\xD7\xC0\xCC\xC7\xC9");
		pCharacter->Object.Scale = 0.95f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		break;
	case 561:
		...
		strcpy(pCharacter->ID,"\xB8\xDE\xB5\xE0\xBB\xE7");
	...
	case 560:
		...
		strcpy(pCharacter->ID,"\xBB\xE7\xC7\xC7\xC4\xFD");
		pCharacter->Object.Scale = 1.5f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		break;
	case 558:
		...
		strcpy(pCharacter->ID,"\xBE\xC6\xC0\xCC\xBD\xBA \xB3\xD7\xC0\xCC\xC7\xC9");
		pCharacter->Object.Scale = 1.1f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		break;
	case 559:
		...
		strcpy(pCharacter->ID,"\xBD\xA6\xB5\xB5\xBF\xEC \xB8\xB6\xBD\xBA\xC5\xCD");
