...
void CNewUIRadioGroupButton::ChangeRadioText(const std::list<unicode::t_string>& textlist )
{
	std::list<unicode::t_string>::const_iterator textiter = textlist.begin();
	...
	for( RadioButtonList::iterator iter = m_RadioList.begin(); iter != m_RadioList.end(); )
	{
		...
		std::list<unicode::t_string>::const_iterator curtextiter = textiter;
		++textiter;
