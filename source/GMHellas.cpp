    ...
    case ITEM_POTION+28:
        {
            ...
            sprintf ( TextList[TextNum], "%s", GlobalText[1184] );  TextListColor[TextNum] = TEXT_COLOR_DARKBLUE; TextNum++;
    ...
    case ITEM_POTION+29 :
        {
            ...
            if ( ip->Durability>=5 )
            {
                sprintf ( TextList[TextNum], "%s", GlobalText[1182] ); TextListColor[TextNum] = TEXT_COLOR_YELLOW; TextNum++;
            }
            else
            {
...
CHARACTER* CreateHellasMonster ( int Type, int PositionX, int PositionY, int Key )
{
	...
	case 334:
		...
		o = &c->Object;
        o->BlendMesh = 1;
		strcpy(c->ID,"\xC0\xE5\xBC\xF6\xB0\xC5\xBA\xCF");
        break;
    case 145 :
    case 175:
    case 183:
	...
	case 336:
        ...
        o->SubType   = 9;
        o->BlendMesh = 0;
		strcpy(c->ID,"\xB4\xEB\xC7\xFC \xBA\xED\xB7\xE7\xB3\xAA\xC0\xCC\xC6\xAE");
        break;
    case 146 :
    case 176:
    case 184:
	...
	case 333:
		...
		c->Object.Scale = 0.8f;
		o = &c->Object;
		strcpy(c->ID,"\xB6\xF8\xBD\xBA\xC5\xCD");
        break;
    case 147:
    case 177:
    case 185:
	...
	case 331:
		...
		o = &c->Object;
        o->BlendMesh = 1;
		strcpy(c->ID,"\xB0\xA1\xBF\xC0\xB8\xAE");
        break;
    case 148:
    case 178:
    case 186:
	...
	case 332:
		...
		o = &c->Object;
        o->BlendMesh = 0;
		strcpy(c->ID,"\xBA\xED\xB7\xE7\xB3\xAA\xC0\xCC\xC6\xAE");
        break;
    case 149:
    case 179:
    case 187:
	...
	case 335:
		...
		o = &c->Object;
        o->BlendMesh = 3;
		strcpy(c->ID,"\xB8\xB6\xB8\xB0\xBA\xB8\xC0\xCC");
        break;
    case 160:
    case 180:
    case 188:
	...
	case 337:
		...
		c->Object.Scale = 1.2f;
		o = &c->Object;
		strcpy(c->ID,"\xC4\xEF\xB5\xD0\xC8\xC4\xBA\xB8");
        break;
    case 161:
    case 181:
    case 189:
...
//		c->Object.Scale = 1.9f;
		o = &c->Object;
		strcpy(c->ID,"\xC1\xF8\xC2\xA5\xC4\xEF\xB5\xD0");
		o->LifeTime = 100;
        break;
    }
