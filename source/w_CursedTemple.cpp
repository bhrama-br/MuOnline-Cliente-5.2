...
CHARACTER* CursedTemple::CreateCharacters(int iType, int iPosX, int iPosY, int iKey)
{
	...
	case 383:
		{
			...
			strcpy(pCharacter->ID,"\xBF\xAC\xC7\xD5\xB1\xBA \xBC\xBA\xB9\xB0\xBA\xB8\xB0\xFC\xC7\xD4");
	...
	case 384:
		{
			...
			strcpy(pCharacter->ID,"\xC8\xAF\xBF\xB5\xB1\xB3\xB4\xDC \xBC\xBA\xB9\xB0\xBA\xB8\xB0\xFC\xC7\xD4");
	...
	case 401:
		{
			...
			strcpy(pCharacter->ID, "\xC8\xAF\xBF\xB5\xB1\xB3\xB4\xDC\xC0\xC7 \xB8\xC1\xB7\xC9(\xB9\xF8\xB0\xB3)");
	...
	case 402:
		{
			...
			strcpy(pCharacter->ID, "\xC8\xAF\xBF\xB5\xB1\xB3\xB4\xDC\xC0\xC7 \xB8\xC1\xB7\xC9(\xBE\xF3\xC0\xBD)");
			pCharacter->Object.Scale = 1.0f;
		    pCharacter->Weapon[0].Type = -1;
		    pCharacter->Weapon[1].Type = -1;
		}
	...
	case 403:
		{
			...
			strcpy(pCharacter->ID, "\xC8\xAF\xBF\xB5\xB1\xB3\xB4\xDC\xC0\xC7 \xB8\xC1\xB7\xC9(\xB5\xB6)");
			pCharacter->Object.Scale = 1.0f;
		    pCharacter->Weapon[0].Type = -1;
		    pCharacter->Weapon[1].Type = -1;
		}
	...
	case 404:
		{
			...
			strcpy(pCharacter->ID,"\xB9\xC2\xBF\xAC\xC7\xD5");
	...
	case 405:
		{
			pCharacter = CreateCharacter(iKey,MODEL_PLAYER,iPosX,iPosY);
			strcpy(pCharacter->ID,"\xC8\xAF\xBF\xB5\xB1\xB3\xB4\xDC");
			pCharacter->Object.Scale = 1.f;
...
void CursedTemple::UpdateTempleSystemMsg(int _Value)
{
	...
	unicode::_sprintf(szText, "%s", GlobalText[2367]);
	switch(_Value)
	{
	case 0:
		break;
