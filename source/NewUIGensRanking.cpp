...
void CNewUIGensRanking::RenderTexts()
{
	...
	sprintf(szText, "%s", GlobalText[3095]);
	_y += 24;
	...
	g_pRenderText->SetFont(g_hFontBold);
	sprintf(szText, "%s", GlobalText[3098]);
	_y += 23;
	...
	g_pRenderText->SetTextColor(230, 230, 0, 255);
	g_pRenderText->SetFont(g_hFontBold);
	sprintf(szText, "%s", GlobalText[3096]);
	_y += 23;
	g_pRenderText->RenderText(_x+13, _y, szText, 74, 0, RT3_SORT_CENTER);
	g_pRenderText->SetFont(g_hFont);
	...
	g_pRenderText->SetFont(g_hFontBold);
	g_pRenderText->SetTextColor(230, 230, 0, 255);
	sprintf(szText, "%s", GlobalText[3100]);
...
void CNewUIGensRanking::SetTitleName()
{
	...
	unicode::_sprintf(_szTempText, "%s", GlobalText[3104]);
