...
void SEASON3B::CNewUICharacterInfoWindow::SetPos(int x, int y)
{
	...
	m_BtnStat[STAT_STRENGTH].SetPos(x + 120, y + HEIGHT_STRENGTH + 2);
	m_BtnStat[STAT_DEXTERITY].SetPos(x + 120, y + HEIGHT_DEXTERITY + 2);
	m_BtnStat[STAT_VITALITY].SetPos(x + 120, y + HEIGHT_VITALITY + 2);
	m_BtnStat[STAT_ENERGY].SetPos(x + 120, y + HEIGHT_ENERGY + 2);
	m_BtnStat[STAT_CHARISMA].SetPos(x + 120, y + HEIGHT_CHARISMA + 2);
...
void SEASON3B::CNewUICharacterInfoWindow::RenderFrame()
{
	...
	}	SetLegacyColor4f(0.0f, 0.0f, 0.0f, 0.5f);
...
#else //PBG_ADD_NEWCHAR_MONK_SKILL
			// 208 "\xB9\xE6\xBE\xEE\xB7\xC2(\xC0\xB2): %d (%d)"
