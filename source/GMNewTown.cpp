...
// 			case 145:
	...
	case 149:		case 150:		case 151:		case 152:		case 153:		case 154:		case 155:
		if (pObject->HiddenMesh != -2)
		{
			...
			{
				assert(!"\xB0\xF8\xB0\xDD\xB5\xBF\xC0\xDB\xC0\xCC \xBE\xF8\xB4?");
			}
			pObject->Owner = pNewObject;
		}
		break;
...
CHARACTER* GMNewTown::CreateNewTownMonster(int iType, int PosX, int PosY, int Key)
{
	...
	case 415:
		...
		strcpy(pCharacter->ID,"\xBD\xC7\xBA\xF1\xBE\xC6");
	...
	case 416:
		...
		strcpy(pCharacter->ID,"\xB7\xB9\xBE\xC6");
		pCharacter->Object.Scale = 1.0f;
	...
	case 417:
		...
		strcpy(pCharacter->ID,"\xB8\xB6\xB8\xA3\xBC\xBC");
	...
	case 418:
		...
		strcpy(pCharacter->ID,"\xB1\xE2\xB1\xAB\xC7\xD1 \xC5\xE4\xB3\xA2");
	...
	case 419:
		...
		strcpy(pCharacter->ID,"\xC8\xE4\xC3\xF8\xC7\xD1 \xC5\xE4\xB3\xA2");
	...
	case 420:
		...
		strcpy(pCharacter->ID,"\xB4\xC1\xB4\xEB\xC0\xCE\xB0\xA3");
		pCharacter->Object.Scale = 1.0f * 0.95f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		break;
	case 421:
		...
		strcpy(pCharacter->ID,"\xBF\xC0\xBF\xB0\xB5\xC8 \xB3\xAA\xBA\xF1");
	...
	case 422:
		...
		strcpy(pCharacter->ID,"\xC0\xFA\xC1\xD6\xB9\xDE\xC0\xBA\xB8\xAE\xC4\xA1");
		pCharacter->Object.Scale = 1.0f * 0.95f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		break;
	case 423:
		...
		strcpy(pCharacter->ID,"\xC5\xE4\xC5\xDB\xB0\xF1\xB7\xBD");
	...
	case 424:
		...
		strcpy(pCharacter->ID,"\xB1\xAB\xBC\xF6 \xBF\xEC\xBE\xBE");
	...
	case 425:
		...
		strcpy(pCharacter->ID,"\xB1\xAB\xBC\xF6 \xBF\xEC\xBE\xBE \xB4\xEB\xC0\xE5");
