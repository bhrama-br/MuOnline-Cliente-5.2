...
{	
	...
	{
		m_Pos.x = x; m_Pos.y = y;
		m_Button[CURSEDTEMPLEENTER_OPEN].ChangeButtonInfo(
			m_Pos.x + (((CURSEDTEMPLE_ENTER_WINDOW_WIDTH / 2) - 54) / 2),
			m_Pos.y + 203, 54, 23);
		m_Button[CURSEDTEMPLEENTER_EXIT].ChangeButtonInfo(
			m_Pos.x + (CURSEDTEMPLE_ENTER_WINDOW_WIDTH / 2) + (((CURSEDTEMPLE_ENTER_WINDOW_WIDTH / 2) - 54) / 2),
			m_Pos.y + 203, 54, 23);
	}
