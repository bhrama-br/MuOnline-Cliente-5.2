...
#else
	// TODO(Platform): o bloco acima e assembly x86 de 32 bits chamando enderecos
	// absolutos (0x00409B10 e 0x00500E80) dentro de um main.exe especifico. Nao
	// existe equivalente fora daquele binario; a troca de idioma tera de passar
	// por uma funcao de verdade quando o subsistema for portado.
	(void)lang; (void)m_CallFunc; (void)m_CallFunc2;
#endif
