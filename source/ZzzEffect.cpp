    ...
    case MODEL_LIGHTNING_SHOCK:
    {
        ...
        else if (o->SubType == 1)
        {
            ...
            for (int i = 0; i < 11; ++i)
            {
                ...
                Vector(o->Position[0] + (rand() % 70 - 35) * 1.0f, o->Position[1] + (rand() % 70 - 35) * 1.0f,
                    o->Position[2] + (rand() % 70 - 35) * 1.0f, vPos);
                CreateParticleFpsChecked(BITMAP_LIGHTNING_MEGA1 + rand() % 3, vPos, pObject->Angle, vLight, 0, fScale);	// Àü±â
            }
    ...
    case MODEL_PIERCING:
        ...
        */
        ...
        if (o->SubType == 1)
        {
            ...
            CreateJointFpsChecked(BITMAP_JOINT_THUNDER, o->Position, o->Position, o->Angle, 3, NULL, 20.f, 7); //  Àü±â
