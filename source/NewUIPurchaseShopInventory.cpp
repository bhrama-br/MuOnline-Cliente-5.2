...
SEASON3B::CNewUIPurchaseShopInventory::CNewUIPurchaseShopInventory() : m_pNewUIMng( NULL ), m_pNewInventoryCtrl( NULL ), m_Button( NULL )
{
	m_Pos.x = m_Pos.y = 0;
...
void SEASON3B::CNewUIPurchaseShopInventory::SetPos(int x, int y)
{
	...
	if (m_pNewInventoryCtrl)
		m_pNewInventoryCtrl->SetPos(x + 16, y + 90);
	if (m_Button)
		m_Button->SetPos(x + 13, y + 391);
}
