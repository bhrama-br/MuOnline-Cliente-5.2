...
#ifdef _WIN32
			// Caminho original preservado no Windows. Chama o slot 0 da vtable de
			// OBJECT com (this, 1): no ABI da MSVC esse slot e o "scalar deleting
			// destructor", entao o efeito e exatamente o de um delete.
...
#else
			// O truque acima depende do layout de vtable da MSVC em 32 bits e nao
			// existe em clang/arm64 — o cast para DWORD ainda truncaria o ponteiro.
			// OBJECT tem destrutor virtual, entao delete faz a mesma coisa de forma
			// portavel.
			delete m_Obj;
#endif
