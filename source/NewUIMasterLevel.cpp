					...
					if (CheckMouseIn(Loc[Skill] + 5 + ((SKILL_ICON_WIDTH + 19) * sx) + PosX, 75 + ((SKILL_ICON_HEIGHT + 14) * nsy), 15, 21))
					{
							...
							)
						{
							...
							case AT_SKILL_LIFE_UP:
								sprintf(TextList[ib], "%s", GlobalText[1786]);
								break;
							case AT_SKILL_SOUL_UP:
								sprintf(TextList[ib], "%s", GlobalText[1783]);
								break;
...
void SEASON3B::CNewUIMasterLevel::Render_Text()
{
	...
	//unicode::_sprintf( lpszStr, "%s", GlobalText[20]);
