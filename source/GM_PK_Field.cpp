...
CHARACTER* CGM_PK_Field::CreateMonster(int iType, int PosX, int PosY, int Key)
{
	...
	{
		// A funcao devolve CHARACTER*; "return false" so compila no MSVC.
		return NULL;
	}
	...
	case 480:
		{
			...
			strcpy(pCharacter->ID,"\xC1\xBB\xBA\xF1 \xC5\xF5\xBB\xE7");
	...
	case 482:
		{
			...
			strcpy(pCharacter->ID,"\xB5\xC7\xBB\xEC\xBE\xC6\xB3\xAD \xB0\xCB\xC5\xF5\xBB\xE7");
			pCharacter->Object.Scale = 1.0f;
			pCharacter->Weapon[0].Type = -1;
			pCharacter->Weapon[1].Type = -1;
			pCharacter->Object.m_iAnimation = 0;
	...
	case 484:
		{
			...
			strcpy(pCharacter->ID,"\xC0\xED\xB4\xF5\xB9\xCC \xB5\xB5\xBB\xEC\xC0\xDA");
	...
	case 486:
		{
			...
			strcpy(pCharacter->ID,"\xC7\xC7\xC0\xC7 \xBE\xCF\xBB\xEC\xC0\xDA");
			pCharacter->Object.Scale = 1.0f;
			pCharacter->Weapon[0].Type = -1;
			pCharacter->Weapon[1].Type = -1;
			pCharacter->Object.m_iAnimation = 0;
	...
	case 487:
		{
			...
			strcpy(pCharacter->ID,"\xC0\xDC\xC8\xA4\xC7\xD1 \xC7\xC7\xC0\xC7 \xBE\xCF\xBB\xEC\xC0\xDA");
			pCharacter->Object.Scale = 1.0f;
			pCharacter->Weapon[0].Type = -1;
			pCharacter->Weapon[1].Type = -1;
			pCharacter->Object.m_iAnimation = 0;
	...
	case 489:
		{
			...
			strcpy(pCharacter->ID,"\xBA\xD2\xC5\xB8\xB4\xC2 \xBF\xEB\xBE\xCF \xB0\xC5\xC0\xCE");
			pCharacter->Object.Scale = 1.0f;
			pCharacter->Weapon[0].Type = -1;
			pCharacter->Weapon[1].Type = -1;
			pCharacter->Object.m_iAnimation = 0;
	...
	case 490:
		{
			...
			strcpy(pCharacter->ID,"\xC6\xF7\xBE\xC7\xC7\xD1 \xBF\xEB\xBE\xCF \xB0\xC5\xC0\xCE");
			pCharacter->Object.Scale = 1.0f;
			pCharacter->Weapon[0].Type = -1;
			pCharacter->Weapon[1].Type = -1;
			pCharacter->Object.m_iAnimation = 0;
