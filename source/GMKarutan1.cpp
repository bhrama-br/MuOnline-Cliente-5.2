...
CHARACTER* CGMKarutan1::CreateMonster(int iType, int PosX, int PosY, int Key)
{
	...
	case 576:
		...
		strcpy(pCharacter->ID, "\xB3\xAA\xB8\xA3\xC4\xDC\xB5\xE5\xB6\xF3");
