...
// Tipo subjacente explicito: permite a declaracao adiantada em UIControls.h sem
// arrastar este cabecalho (e a rede) junto. O tipo precisa casar nos dois lugares.
