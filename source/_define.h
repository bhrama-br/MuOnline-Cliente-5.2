...
//
#define NEW_EQUIPMENT_HELPER_SP     236
#define NEW_EQUIPMENT_HELPER_SUP    237
#define NEW_EQUIPMENT_RING_RIGHT    238
#define NEW_EQUIPMENT_RING_LEFT     239
//
...
#define MAX_NEW_EQUIPMENT_INDEX     249
//
